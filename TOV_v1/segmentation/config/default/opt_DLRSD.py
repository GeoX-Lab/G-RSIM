...
# -*- coding: utf-8 -*-
'''
Default Config about DLRSD dataset, segmentation mode
'''
from config.category import DLRSD
...
class Config(object):
    ...
    # Path and file
    root = ''
    data_dir = root + 'segmentation/Seg_data/DLRSD'
    ckpt = root + 'Task_models/DLRSD'
    env = 'DLRSD'  # visdom 环境
