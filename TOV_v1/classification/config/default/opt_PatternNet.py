...
# -*- coding: utf-8 -*-
'''
Default Config about PatternNet dataset, classification mode
'''
...
class Config(object):
    ...
    # Path and file
    root = ''
    data_dir = root + 'classification/Cls_data/PatternNet'
    ckpt = root + 'Task_models/PatternNet'
    env = 'PatternNet'  # visdom 环境
