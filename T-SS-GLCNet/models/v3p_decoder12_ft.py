...
class Decoder(nn.Module):
    def __init__(self, class_num, bn_momentum=0.1):
        ...
        self.conv3t = nn.Conv2d(256, 256, kernel_size=3, padding=1, bias=False)
        self.bn3t = SynchronizedBatchNorm2d(256, momentum=bn_momentum)
    ...
    def forward(self, x, low_level_feature):
        ...
        x_4_cat = self.conv3t(x_4_cat)
        x_4_cat = self.bn3t(x_4_cat)
        x_4_cat = self.relu(x_4_cat)
